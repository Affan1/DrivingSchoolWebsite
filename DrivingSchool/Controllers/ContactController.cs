...
namespace DrivingSchool.Controllers
{
    public class ContactController : Controller
    {
        ...
        public ContactController(SchoolDbContext dbContext, IEmailService emailService, ILogger<ContactController> logger)
        {
            _context = dbContext;
        ...
        public async Task<IActionResult> Index(Appointments appointments)
        {
            _logger.LogInformation(
                  "Appointment submission started for {Email} in Contact Page",
                         appointments?.Email);
...
<tr>
        ...
        <p style='font-size:12px; color:#777;'>
            This email was generated automatically on {DateTime.Now:f}
                    ...
                    // ADMIN EMAIL LOGGER
                    _logger.LogInformation(
                        "Sending admin appointment email for {Email} in Contact Page",
                        appointments.Email);
    ...
    <body style='font-family: Arial, sans-serif; color:#333; line-height:1.6;'>
        ...
        <p style='font-size:12px; color:#777;'>
            ...
            Please do not reply unless you need to update your details.
                    ...
                    // CLIENT EMAIL LOGGER
                    _logger.LogInformation(
                        "Sending client confirmation email to {Email} in Contact Page",
                        appointments.Email);
                    ...
                    _logger.LogInformation(
                        "Appointment saved successfully for {Email} in Contact Page",
                            appointments.Email);
                ...
                catch (Exception ex)
                {
                    _logger.LogError(
            ex,
            "Error processing appointment for {Email} in Contact Page",
            appointments?.Email);
